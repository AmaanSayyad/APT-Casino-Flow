    ...
    >
      ...
      <div className={
        ...
        <h2 className="text-[#B3B3B3] mt-4 text-lg sm:text-xl leading-relaxed max-w-3xl">
          <span className="text-white font-semibold">Autonomous Provably Transparent</span> gaming powered by <span className="text-white font-semibold">Flow Blockchain</span> & <span className="text-white font-semibold">Flow VRF</span>. Experience decentralized randomness with cryptographic fairness you can verify, not just trust.
        </h2>
